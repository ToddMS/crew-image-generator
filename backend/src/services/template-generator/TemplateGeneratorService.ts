...
export class TemplateGeneratorService {
  private backgroundComponents: Map<string, BackgroundComponent> = new Map();
  private nameDisplayComponents: Map<string, NameDisplayComponent> = new Map();
  ...
  private initializeComponents(): void {
    ...
    this.nameDisplayComponents = new Map<string, NameDisplayComponent>([
