...
import { MdClose, MdPeople, MdSave, MdImage, MdPhoto, MdArrowForward, MdArrowBack } from 'react-icons/md';
      ...
      content: (
        <Box sx={{ textAlign: 'center' }}>
          ...
          <Typography variant="body1" sx={{ mb: 3, color: theme.palette.text.secondary }}>
            RowGram helps you manage rowing crews and generate beautiful lineup images for races, social media, and team records.
          </Typography>
      ...
      content: (
        <Box>
          ...
          <Box component="ul" sx={{ pl: 2, color: theme.palette.text.secondary }}>
            <li style={{ marginBottom: 8 }}>Enter your <strong>club name</strong> and <strong>race name</strong></li>
            <li style={{ marginBottom: 8 }}>Choose your <strong>boat class</strong> (8+, 4+, 4-, etc.)</li>
            <li style={{ marginBottom: 8 }}>Give your boat a <strong>name</strong></li>
            <li style={{ marginBottom: 8 }}>Add all crew members with their <strong>seat positions</strong></li>
          </Box>
          <Box sx={{ 
            mt: 2, 
            p: 2, 
    ...
    },
    {
      ...
      content: (
        <Box>
          ...
          <Box component="ul" sx={{ pl: 2, color: theme.palette.text.secondary }}>
            <li style={{ marginBottom: 8 }}>Click the <strong>"Save Crew"</strong> button</li>
            <li style={{ marginBottom: 8 }}>Your crew will appear in the <strong>"My Crews"</strong> section</li>
    ...
    },
    {
      ...
      content: (
        <Box>
          ...
          <Box component="ul" sx={{ pl: 2, color: theme.palette.text.secondary }}>
            <li style={{ marginBottom: 8 }}>Click <strong>"Generate Image"</strong> on any crew</li>
            <li style={{ marginBottom: 8 }}>Choose from <strong>3 template styles</strong></li>
            <li style={{ marginBottom: 8 }}>Customize <strong>colors</strong> or use saved presets</li>
            <li style={{ marginBottom: 8 }}>Add your <strong>club logo</strong> (optional)</li>
            <li style={{ marginBottom: 8 }}>Generate <strong>multiple crews at once</strong> with bulk mode</li>
          </Box>
          <Box sx={{ 
            mt: 2, 
            p: 2, 
    ...
    },
    {
      ...
      content: (
        <Box>
          ...
          <Box component="ul" sx={{ pl: 2, color: theme.palette.text.secondary }}>
            <li style={{ marginBottom: 8 }}>Click <strong>"Gallery"</strong> in the header</li>
            <li style={{ marginBottom: 8 }}>View all your generated images</li>
            <li style={{ marginBottom: 8 }}>Filter by club, race, or crew</li>
            <li style={{ marginBottom: 8 }}>Download individual images or <strong>bulk ZIP files</strong></li>
    ...
    },
    {
      ...
      content: (
        <Box sx={{ textAlign: 'center' }}>
          ...
          <Typography variant="body1" sx={{ mb: 3, color: theme.palette.text.secondary }}>
            You now know everything you need to manage crews and create professional lineup images with RowGram.
          </Typography>
          <Box sx={{ 
            p: 3, 
            ...
            <Typography variant="body2" sx={{ color: theme.palette.text.secondary, textAlign: 'left' }}>
              • Use consistent naming for easy searching<br/>
              • Save color presets for your club branding<br/>
              • Try bulk generation for multiple crews<br/>
              • Check Analytics to see your usage patterns
            </Typography>
          </Box>
          <Typography variant="body2" sx={{ color: theme.palette.text.secondary }}>
    ...
    >
      <Box sx={{ position: 'relative' }}>
        ...
        <DialogContent sx={{ p: 4 }}>
          ...
          {/* Content */}
          <Box sx={{ minHeight: 300, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <Box sx={{ mb: 3 }}>
